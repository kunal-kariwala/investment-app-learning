...
function Frame() {
  return (
    <div className="bg-[#00b386] box-border content-stretch flex gap-[10px] items-center justify-center overflow-clip px-[16px] py-[20px] relative rounded-[8px] shrink-0">
